...
class turmaDAO extends database {
    ...
    public function load($fields = "*", $add = "") {
        ...
        $sql = "SELECT $fields FROM turma$add";
        return $this->selectDB($sql, null, 'turma');
    }
    ...
    public function insert($fields, $params = null) {
        ...
        $sql = "INSERT INTO turma ($fields) VALUES ($numparams)";
