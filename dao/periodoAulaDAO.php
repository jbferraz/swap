...
/**
 * Description of periodoAulaDAO
 *
 * @author jairb
 */
include_once("../class/periodoAula.php");

class periodoAulaDAO extends database {
    ...
    public function load($fields = "*", $add = "") {
        ...
        $sql = "SELECT $fields FROM periodoAula$add";
        return $this->selectDB($sql, null, 'periodoAula');
    }
    ...
    public function insert($fields, $params = null) {
        ...
        $sql = "INSERT INTO periodoAula ($fields) VALUES ($numparams)";
    ...
    public function update($fields, $params = null, $where = null) {
        ...
        $sql = "UPDATE periodoAula SET $fields_T";
        if (isset($where)) {
            $sql .= " WHERE $where";
        }
