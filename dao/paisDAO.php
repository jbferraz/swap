 ...
 * @author jairb
 */
include_once("../class/pais.php");

class paisDAO extends database{
    ...
    public function load($fields = "*", $add = "") {
        ...
        $sql = "SELECT $fields FROM pais$add";
        return $this->selectDB($sql, null, 'pais');
    }
    ...
    public function insert($fields, $params = null) {
        ...
        $sql = "INSERT INTO pais ($fields) VALUES ($numparams)";
