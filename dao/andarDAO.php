...
/**
 * Description of andarDAO
 *
 * @author jairb
 */
include_once("../class/andar.php");

class andarDAO extends database{
    ...
    public function load($fields = "*", $add = "") {
        ...
        $sql = "SELECT $fields FROM andar$add";
        return $this->selectDB($sql, null, 'andar');
    }
    ...
    public function insert($fields, $params = null) {
        ...
        $sql = "INSERT INTO andar ($fields) VALUES ($numparams)";
