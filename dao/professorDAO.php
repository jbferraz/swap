...
class professorDAO extends database{
    ...
    public function load($fields = "*", $add = "") {
        ...
        $sql = "SELECT $fields FROM professor$add";
        return $this->selectDB($sql, null, 'professor');
    }
    ...
    public function insert($fields, $params = null) {
        ...
        $sql = "INSERT INTO professor ($fields) VALUES ($numparams)";
    ...
    public function update($fields, $params = null, $where = null) {
        ...
        $sql = "UPDATE professor SET $fields_T";
        if (isset($where)) {
            $sql .= " WHERE $where";
        }
